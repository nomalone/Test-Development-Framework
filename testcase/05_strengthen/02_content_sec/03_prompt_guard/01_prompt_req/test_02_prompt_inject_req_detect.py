...
class TestPromptInjectReqDetect(seldom.TestCase):
    """增强管理-内容安全-提示词注入防护:提问-开启-监测"""
    ...
    def start_class(cls):
        ...
        cls.test_data = json_data.get("5-2-3-prompt-inject-req-detect", [])

    def test_prompt_inject_req_detect(self):
        """调用大模型，发起请求"""
        # 确保有测试数据
