...
class TestPromptInjectCTClose(seldom.TestCase):
    """增强管理-内容安全-提示词注入防护:监测上下文-关闭"""
    ...
    @seldom.file_data("prompt_inject_ct_data.json", key="5-2-3-prompt-inject-ct-close")
    def test_prompt_inject_ct_close(self, scene, req, resp):
        """调用大模型，发起请求"""
        # 1. 发送API请求
