...
class TestPromptBreakAllDetectReq(seldom.TestCase):
    """增强管理-内容安全-模型越狱防护:所有规则-开启-监测-提问命中"""
    ...
    def start_class(cls):
        ...
        cls.test_data = json_data.get("5-2-3-prompt-break-all-002", [])

    def test_prompt_break_all_detect_req(self):
        """调用大模型，发起请求"""
        # 确保有测试数据
