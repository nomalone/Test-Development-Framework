...
class TestPromptBreakAllClose(seldom.TestCase):
    """增强管理-内容安全-模型越狱防护:所有规则-关闭"""
    ...
    # 第一个方法：收集所有测试数据
    @seldom.file_data("prompt_break_all_data.json", key="5-2-3-prompt-break-all-001")
    def test_prompt_break_all_close(self, scene, req, resp):
        """调用大模型，发起请求"""
        # 1. 发送API请求
