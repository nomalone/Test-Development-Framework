...
class TestValuesReqClose(seldom.TestCase):
    """增强管理-内容安全-价值观模型监测:提问-关闭"""
    ...
    @seldom.file_data("values_req_data.json", key="5-2-2-values-req-001")
    def test_values_req_close(self, scene, req, resp):
        """调用大模型，发起请求"""
        # 1. 发送API请求
