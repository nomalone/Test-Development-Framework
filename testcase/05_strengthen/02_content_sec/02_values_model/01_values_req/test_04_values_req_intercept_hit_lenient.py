...
class TestValuesReqInterceptHitLenient(seldom.TestCase):
    """增强管理-内容安全-价值观模型监测:提问-开启-拦截-命中-宽松"""
    ...
    @seldom.file_data("values_req_data.json", key="5-2-2-values-req-004")
    def test_values_req_intercept_hit_lenient(self, scene, req, resp):
        """调用大模型，发起请求"""
        # 1. 发送API请求
