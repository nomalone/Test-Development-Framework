...
class TestValuesReqNoHit(seldom.TestCase):
    """增强管理-内容安全-价值观模型监测:提问-开启-未命中"""
    ...
    @seldom.file_data("values_req_data.json", key="5-2-2-values-req-006")
    def test_values_req_no_hit(self, scene, req, resp):
        """调用大模型，发起请求"""
        # 1. 发送API请求
