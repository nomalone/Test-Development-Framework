...
class TestValuesAllDetectReqHit(seldom.TestCase):
    """增强管理-内容安全-价值观模型监测:所有规则-开启-监测-提问命中"""
    ...
    @seldom.file_data("values_all_data.json", key="5-2-2-values-all-002")
    def test_values_all_detect_req_hit(self, scene, req, resp):
        """调用大模型，发起请求"""
        # 1. 发送API请求
