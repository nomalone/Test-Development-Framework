...
class TestValuesRespNoHit(seldom.TestCase):
    """增强管理-内容安全-价值观模型监测:回答-开启-未命中"""
    ...
    @seldom.file_data("values_resp_data.json", key="5-2-2-values-resp-008")
    def test_values_resp_no_hit(self, scene, req, resp):
        """调用大模型，发起请求"""
        # 1. 发送API请求
