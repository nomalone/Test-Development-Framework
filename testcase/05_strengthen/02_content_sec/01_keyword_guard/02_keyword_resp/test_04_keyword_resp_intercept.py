...
class TestKeywordRespIntercept(seldom.TestCase):
    """增强管理-内容安全-关键词监测:回答-开启-拦截"""
    ...
    def start_class(cls):
        ...
        cls.test_data = json_data.get("5-2-1-keyword-resp-intercept", [])

    def test_keyword_resp_intercept(self):
        """调用大模型，发起请求"""
        # 确保有测试数据
