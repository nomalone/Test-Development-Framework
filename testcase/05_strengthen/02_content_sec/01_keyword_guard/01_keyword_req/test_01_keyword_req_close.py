...
class TestKeywordReqClose(seldom.TestCase):
    """增强管理-内容安全-关键词监测:提问-关闭"""
    ...
    @seldom.file_data("keyword_req_data.json", key="5-2-1-keyword-req-close")
    def test_keyword_req_close(self, scene, req, resp):
        """调用大模型，发起请求"""
        # 1. 发送API请求
