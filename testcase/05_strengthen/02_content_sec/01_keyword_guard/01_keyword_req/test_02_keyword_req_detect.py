...
class TestKeywordReqDetect(seldom.TestCase):
    """增强管理-内容安全-关键词监测:提问-开启-监测"""
    ...
    def start_class(cls):
        ...
        cls.test_data = json_data.get("5-2-1-keyword-req-detect", [])

    def test_keyword_req_detect(self):
        """调用大模型，发起请求"""
        # 确保有测试数据
