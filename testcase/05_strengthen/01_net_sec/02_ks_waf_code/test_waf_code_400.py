...
class TestWafCode400(seldom.TestCase):
    """增强管理-网络安全-高级扫描防护: 400"""
    ...
    @seldom.file_data("waf_code_data.json", key="5-1-1-waf-code-400")
    def test_waf_code_400(self, scene, req, resp):
        """调用大模型，发起请求"""
        # 1. 发送API请求
        for i in range(11):
